                        ...
                        <ul class="nav nav-treeview">
                            <?php if(isset($config['search']['search_static'])) { ?>
                                <?php foreach($config['search']['search_static'] as $k => $v) { if(!isset($disabled['search_static'][$k])) {
                                    ...
                                    <li class="nav-item <?=$none?>">
                                        <a class="nav-link <?=$active?>" href="index.php?com=search&act=search_static&type=<?=$k?>" title="<?=$v['title_main']?>"><i class="nav-icon text-sm far fa-caret-square-right"></i><p><?=$v['title_main']?></p></a>
                                    </li>
                                <?php } } ?>
                            <?php } ?>
                            <?php if(isset($config['search']['man_search'])) { ?>
                                <?php foreach($config['search']['man_search'] as $k => $v) { if(!isset($disabled['search'][$k])) {
                                    ...
                                    <li class="nav-item <?=$none?>">
                                        <a class="nav-link <?=$active?>" href="index.php?com=search&act=man_search&type=<?=$k?>" title="<?=$v['title_main_search']?>"><i class="nav-icon text-sm far fa-caret-square-right"></i><p><?=$v['title_main_search']?></p></a>
                                    </li>
                                <?php } } ?>
                            <?php } ?>
                        </ul>
