...
$requick = array(
	...
	/* Bài viết */
	array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"ung-dung","type"=>"ung-dung",'menu'=>true),
	array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"huong-dan-thong-tin","type"=>"huong-dan-thong-tin",'menu'=>false),
	array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"chinh-sach-doi-tac","type"=>"chinh-sach-doi-tac",'menu'=>false),
	array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"chinh-sach","type"=>"chinh-sach",'menu'=>false),
	array("tbl"=>"news","field"=>"id","source"=>"news","com"=>"4-ly-do","type"=>"4-ly-do",'menu'=>false),
	...
	/* Hình ảnh thi công */
	array("tbl"=>"product","field"=>"id","source"=>"product","com"=>"hinh-anh-thi-cong","type"=>"hinh-anh-thi-cong",'menu'=>true),
...
switch($com)
{
	...
	$type = $com;
	$title_crumb = "Ứng dụng";
	break;

	case 'chinh-sach-doi-tac':
	$source = "news";
