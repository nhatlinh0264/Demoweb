...
/* Slogan thương hiệu*/
$nametype = "slogan-ndth";
$config['static'][$nametype]['title_main'] = "Slogan thương hiệu";
$config['static'][$nametype]['tieude'] = true;

/* Slogan thương hiệu 2*/
$nametype = "slogan-ndth2";
$config['static'][$nametype]['title_main'] = "Slogan thương hiệu 2";
$config['static'][$nametype]['tieude'] = true;

/* Nhận ưu đãi giảm giá */
$nametype = "nhan-uu-dai-giam-gia";
$config['static'][$nametype]['title_main'] = "Nhận ưu đãi giảm giá";
$config['static'][$nametype]['tieude'] = true;
$config['static'][$nametype]['noidung'] = true;
